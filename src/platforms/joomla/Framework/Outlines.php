...
class Outlines extends BaseOutlines
{
    ...
    public function current($template = null)
    {
        ...
        $outline = $template->params->get('configuration', $template->id);

        return is_dir($locator("gantry-config://{$outline}")) ? $outline : $preset;
    }
